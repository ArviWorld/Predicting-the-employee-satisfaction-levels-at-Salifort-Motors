...
-   Raw data - HR_capstone_dataset.csv from the HR department is used to
    assess the needs of the Senior leadership team.
...
packages and the data set  - Checking the descriptive statistics\
